...
class SendPost extends AsyncTask<Void, Void, String> {
    ...
    String category,password,title;

    public SendPost(String category , String password, String title)
    {
    ...
    public String executeClient() {
        ...
        // Post객체 생성
        HttpPost httpPost = new HttpPost("http://192.168.0.108/noticeboard/post.php");
