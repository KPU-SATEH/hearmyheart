...
import static com.example.hearmyheart.R.id.bad;

/**
 * Created by Administrator on 2017-01-16.
 */
public class Transport_noticeboard extends AppCompatActivity {
    String myJSON;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getData("http://13.112.211.84/noticeboard/transport_noticeboard.php"); // 서버 주소
    ...
    protected void showList(){
        try{
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Transport_noticeboard.this,boardList, R.layout.list_item,
                    new String[]{TAG_TITLE,TAG_CATEGORY,TAG_VIEW,TAG_DATE,TAG_GOOD,TAG_BAD},
                    new int[]{R.id.tt, R.id.category, R.id.view, R.id.date, R.id.good, bad}
            );
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    int bad = Integer.parseInt(Bad.get(TAG_BAD));

                    HashMap<String,String> stitle  = (HashMap<String,String>)boardList.get(position);
                    s_title = stitle.get(TAG_TITLE);

                    //Toast.makeText(getBaseContext(), Integer.toString(idx), Toast.LENGTH_SHORT).show();
