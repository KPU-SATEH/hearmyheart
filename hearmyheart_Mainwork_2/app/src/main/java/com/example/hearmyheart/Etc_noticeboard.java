 ...
 */
public class Etc_noticeboard extends AppCompatActivity {
    String myJSON;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getData("http://13.112.211.84/noticeboard/etc_noticeboard.php"); // 서버 주소
    ...
    protected void showList(){
        try{
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Etc_noticeboard.this,boardList, R.layout.list_item,
